...
from minecraft_ai.agent_lifecycle import AGENT_FILE, AgentProcess, agent_alive, stop_agent_process
from minecraft_ai.config import app_paths
from minecraft_ai.emergency import (
    emergency_reason,
...
from minecraft_ai.platforms import (
    HostMonitorBinding,
    IsolatedX11Capture,
    IsolationError,
...
<div class="card wide"><div class="label">Latest cognition</div><div class="reason" id="reason">Waiting for agent telemetry.</div><div class="label" id="plan"></div><div class="label" id="outcome"></div></div></section>
